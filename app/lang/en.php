...
return [
    ...
    'shelf.mark.read'    => 'Mark as read',
    'shelf.mark.unread'  => 'Mark as unread',
    ...
    'filter.rating.from' => '{stars} stars and up',
    'filter.rating.one'  => '1 star and up',
    'filter.sort'        => 'Sort by',
    ...
    'scan.will.read'     => 'Goes in as read. Change?',
    'scan.will.unread'   => 'Goes in as unread. Change?',
    ...
    'maintenance.export.full.hint'         => 'For spreadsheets: one row per book, with series, genres and labels. Several names share a cell, separated by semicolons.',
    'maintenance.export.json'              => 'Everything (JSON)',
    'maintenance.export.json.hint'         => 'The same fields for programs: contributors, genres and labels as lists, the series with name and volume.',
    ...
    'tags.remove'            => 'remove',
    'tags.remove.named'      => 'Remove "{name}"',
    'tags.remove.reversible' => 'Undo at any time: the links are kept, only hidden.',
    'tags.removed.inline'    => '"{name}" removed',
    'tags.undo'              => 'Undo',
    'tags.restore'           => 'restore',
    'tags.dropped.heading'   => 'Removed',
    'tags.dropped.hint'      => 'Not deleted, only hidden - with all their links. Future imports will not put them back.',

    'tags.assign.heading'          => 'Assignment from a file',
    'tags.assign.hint'             => 'A CSV with the columns id, genres and labels, such as an edited "All fields" export. Every book in the file gets exactly the genres and labels of its row, several separated by semicolons. Books not in the file are left alone. A preview comes first.',
    'tags.assign.backup'           => 'The way back is an export taken before, read in again through this field:',
    'tags.assign.preview'          => 'Preview',
    'tags.assign.title'            => 'Read assignment: preview',
    'tags.assign.nofile'           => 'Please choose a CSV file.',
    'tags.assign.unreadable'       => 'The file could not be read.',
    'tags.assign.columns'          => 'The file lacks one of the columns id, genres or labels.',
    'tags.assign.empty'            => 'The file has no rows.',
    'tags.assign.moved'            => 'Something on the shelf changed since the preview. This is the new preview; nothing was applied.',
    'tags.assign.conflicts'        => 'These names appear as a genre in one row and as a label in another: {names}. A name can only be one.',
    'tags.assign.summary'          => 'At a glance',
    'tags.assign.books.changed'    => 'Books with a new assignment: {count}',
    'tags.assign.books.same'       => 'Books already assigned like this: {count}',
    'tags.assign.books.outside'    => 'Books on the shelf that are not in the file and stay as they are: {count}',
    'tags.assign.names.new'        => 'Entries created: {count}',
    'tags.assign.names.reused'     => 'Existing entries used again: {count}',
    'tags.assign.dropped'          => 'Entries removed afterwards: {count}',
    'tags.assign.rejected'         => 'Rows refused: {count}',
    'tags.assign.rejected.heading' => 'Rows refused',
    'tags.assign.rejected.hint'    => 'These rows are skipped, and their books keep what they have.',
    'tags.assign.line'             => 'Line {line}',
    'tags.assign.reject.id'        => 'no valid id',
    'tags.assign.reject.unknown'   => 'no book with this id on the shelf',
    'tags.assign.reject.twice'     => 'the same id appears further up',
    'tags.assign.reject.isbn'      => 'the ISBN does not match the book with this id',
    'tags.assign.names.heading'    => 'Genres and labels from the file',
    'tags.assign.name.new'         => 'new',
    'tags.assign.name.reused'      => 'exists already',
    'tags.assign.name.restored'    => 'was removed, comes back',
    'tags.assign.name.kind'        => 'was {from}',
    'tags.assign.name.spelling'    => 'until now "{from}"',
    'tags.assign.drop.heading'     => 'Removed afterwards',
    'tags.assign.drop.hint'        => 'Not in the file and on no book outside it. Removed the way the × removes: hidden, with all their links, restorable. The number is how many books carry the entry today.',
    'tags.assign.books.heading'    => 'Books with a new assignment',
    'tags.assign.col.book'         => 'Book',
    'tags.assign.col.genres'       => 'Genres',
    'tags.assign.col.labels'       => 'Labels',
    'tags.assign.do'               => 'Apply',
    'tags.assign.nothing'          => 'Nothing to do: the shelf is already assigned like this.',
    'tags.assign.blocked'          => 'Correct the file first, then upload it again.',
    'tags.assign.done'             => 'Applied: {books} books reassigned, {created} entries created, {dropped} removed.',
